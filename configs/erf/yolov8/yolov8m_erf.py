...
model = dict(
    type = 'CnnNet',
    structure_info = [
        {'class': 'ConvKXBNRELU', 'act': 'silu', 'in': 3, 'out': 48, 's': 2, 'k': 3}, # 0
        {'class': 'ConvKXBNRELU', 'act': 'silu', 'in': 48, 'out': 96, 's': 2, 'k': 3},
        {'class': 'C2f', 'act': 'silu', 'in': 96, 'out': 96, 's': 1, 'k': 3, 'n': 2}, # 2
        {'class': 'ConvKXBNRELU', 'act': 'silu', 'in': 96, 'out': 192, 's': 2, 'k': 3},
        {'class': 'C2f', 'act': 'silu', 'in': 192, 'out': 192, 's': 1, 'k': 3, 'n': 4}, # 4
        {'class': 'ConvKXBNRELU', 'act': 'silu', 'in': 192, 'out': 384, 's': 2, 'k': 3},
        {'class': 'C2f', 'act': 'silu', 'in': 384, 'out': 384, 's': 1, 'k': 3, 'n': 4}, # 6
        {'class': 'ConvKXBNRELU', 'act': 'silu', 'in': 384, 'out': 576, 's': 2, 'k': 3},
        {'class': 'C2f', 'act': 'silu', 'in': 576, 'out': 576, 's': 1, 'k': 3, 'n': 2}, # 8
    ]
)

""" Budget config """
budgets = [
    dict(type = "flops", budget = 13e9),
    dict(type = "model_size", budget= 12e6),
    dict(type = "bottleneck_entropy", budget= -9.12)
]
