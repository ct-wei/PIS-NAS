    ...
    def get_model_size(self, return_list=False):
        if return_list:
            return self.conv1.get_model_size(
                return_list) + self.conv2.get_model_size(return_list)
        else:
...
class SuperResK1KX(BaseSuperBlock):
    ...
    def __init__(self,
        ...
        :param NAS_mode:
        '''
        structure_info['inner_class'] = 'ResK1KX'
        super().__init__(
